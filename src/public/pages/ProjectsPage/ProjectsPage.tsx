...
export const ProjectsPage = () => {
  ...
  return (
    ...
    <div className="projects-page-container flex flex-1 flex-col h-full w-full items-center justify-start">
      ...
      <div
        className={`skills-container py-10 mb-10 border-t-4 border-blue-500  ${
          theme === "dark" ? "bg-gray-700":"bg-gray-200"
        }`}
        style={{ marginTop: "30pxs" }}
      >
        {projects.map((project)=>(<ProjectComponent start={project.startDate} end={project.endDate} rol={project.rol} description={project.description} skills={project.technologies} />))}
      </div>
    </div>
